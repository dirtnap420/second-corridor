...
export const TALENT_SANKEY = {
  ...
  nodes: [
    ...
    { id: 'occ', label: 'Onondaga Community College', layer: 0, src: 'occ-micron' },
    ...
    { id: 'certs', label: 'Certificates & associate degrees', layer: 1, src: 'emerge-micro-2024' },
  ...
  links: [
    ...
    { source: 'occ', target: 'certs', value: 2 },
    { source: 'occ', target: 'cleanroom', value: 2.5 },
    { source: 'cleanroom', target: 'micron-clay', value: 2.5 },
